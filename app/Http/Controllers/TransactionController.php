...
class TransactionController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'from_account_id' => 'required_if:type,payment,transfer|nullable|exists:accounts,id',
            'to_account_id' => 'required_if:type,receipt,transfer|nullable|exists:accounts,id',
            ...
            'transaction_date.before_or_equal' => 'Ngày giao dịch không được lớn hơn ngày hôm nay',
            'currency_id.required' => 'Đơn vị tiền tệ không được để trống',
            'category_id.required' => 'Danh mục không được để trống',
            'from_account_id.exists' => 'Tài khoản không tồn tại',
            'from_account_id.required_if' => 'Vui lòng chọn tài khoản nguồn',
            'to_account_id.exists' => 'Tài khoản không tồn tại',
            'to_account_id.required_if' => 'Vui lòng chọn tài khoản nhận',
