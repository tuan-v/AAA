        ...
        <div class="w-full max-w-md">
            ...
            <div class="bg-white p-6 sm:p-8 rounded-2xl shadow-xl border border-gray-100">
                <form class="space-y-6" method="POST" action="{{ url()->current() }}">
                    ...
                    <div>
                        ...
                        <input id="password" name="password" type="password" required autocomplete="current-password"
                            class="block w-full px-4 py-3 border border-gray-300 rounded-lg
                                          focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent
                                          transition-all duration-200 hover:border-gray-400" placeholder="••••••••">
                    ...
                    <div class="pt-2">
                        <button type="submit" class="w-full flex justify-center items-center py-3.5 px-4 
                ...
                <div>
                    <a href="{{ route('login.google') }}" class="inline-flex w-full justify-center items-center py-3 px-4 border border-gray-300 rounded-lg shadow-sm 
