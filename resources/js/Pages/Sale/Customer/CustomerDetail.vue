...
const viewOrder = async (id) => {
    ...
    try {
        ...
        await alertAction({ title: "Không thể tải chi tiết", message: error.response?.data?.message || "Không tải được chi tiết đơn bán hàng.", confirmText: "Đã hiểu", tone: "danger" });
    }
};
